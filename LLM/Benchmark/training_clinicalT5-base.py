...
def main():
    ...
    #memory_fraction = (16 * 1e9) / total_memory  # Calcola frazione desiderata
    #memory_fraction = min(memory_fraction, 1.0)  # Non superare 100%
    #torch.cuda.set_per_process_memory_fraction(memory_fraction)  # Imposta limite per processo
